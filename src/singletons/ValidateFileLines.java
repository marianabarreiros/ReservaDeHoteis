...
public class ValidateFileLines {
    ...
    private Map<String, LinkedHashSet<LocalDate>> mapClientsEndDates = new LinkedHashMap();
    ...
    public LinkedHashMap<String, LinkedHashSet<LocalDate>> validateFileLines(String string){
        ...
        for(int i = 0; i< stringSplit.length; i++){
            ...
            if(simpleClientFactory.creatClient(client)){
                ...
                mapClientsEndDates.put(simpleClientFactory.getClient().getTypeClient(), 
                                       (LinkedHashSet<LocalDate>) fd.ValidatesDates(dates));  
            }                            
            else
                continue;
        }
    return (LinkedHashMap<String, LinkedHashSet<LocalDate>>) mapClientsEndDates;        
    }
}
